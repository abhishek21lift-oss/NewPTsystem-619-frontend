  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-[10px]">
        ...
        <div className="relative flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-[10px] border border-[var(--border)] bg-[rgba(255,255,255,0.05)] transition-all hover:bg-[rgba(255,255,255,0.09)]">
          <Bell size={15} />
