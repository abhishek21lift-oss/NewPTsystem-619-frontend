const tickerItems = [
  ...
  { color: '#FF3B30', text: 'Abhishek — 8 active clients this month' },
  ...
  { color: '#FFD60A', text: 'Abhishek — 650kg competition total 🥈 Silver' },
  ...
  { color: '#FF3B30', text: '4 expired clients with outstanding dues ₹48,000' },
];
...
export default function TickerBar() {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(90deg, rgba(255,59,48,0.08), rgba(10,132,255,0.06), rgba(48,209,88,0.06), rgba(255,159,10,0.07))',
      }}
    >
      <div className="relative z-[3] shrink-0 whitespace-nowrap px-[14px] text-[10px] font-extrabold uppercase tracking-[1px] text-[var(--red-light)]">
        LIVE
      </div>
